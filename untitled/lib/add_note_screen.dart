...
class _AddNoteScreenState extends State<AddNoteScreen> {
  ...
  void _saveNote() async {
    ...
    await FirebaseFirestore.instance.collection('notes').add({
      ...
      'tags': _selectedTags,
      'isPinned': _isPinned,
      'voicePath': voicePath, // save voice path
    });
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              // Voice note button - NEW
              Row(
                children: [
                  IconButton(
                    icon: Icon(isRecording? Icons.stop_circle : Icons.mic),
                    color: isRecording? Colors.red : Colors.purple.shade700,
                    iconSize: 32,
                    onPressed: () async {
                      if (isRecording) {
                        voicePath = await VoiceService.stopRecording();
                        ...
                        bool started = await VoiceService.startRecording();
                        if (started) {
                  ...
                  Text(isRecording? 'Recording...' : 'Add Voice Note'),
