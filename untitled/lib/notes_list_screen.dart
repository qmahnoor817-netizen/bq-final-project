                                                  ...
                                                  children: [
                                                    ...
                                                    PopupMenuButton(
                                                      ...
                                                      itemBuilder: (ctx) => [
                                                        ...
                                                        const PopupMenuItem(
                                                          value: 'pdf',
                                                          child: Row(children: [Icon(Icons.picture_as_pdf, size: 18, color: Colors.red), SizedBox(width: 8), Text('Export as PDF')]),
                                                        ),
                                                      ],
                                                      onSelected: (val) {
                                                        if (val == 'share') _shareNote(note);
                                                        if (val == 'summary') _summarizeNote(note);
                                                        if (val == 'pdf') PdfService.exportNote(note.title, note.content); // new
                                                      },
                                                    ),
                                                  ],
                                                ),
